...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './cantor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CANTOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CANTOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CANTOR actions', async () => {
      const arg = { id: 26260 };
    ...
    it('dispatches UPDATE_CANTOR actions', async () => {
      const arg = { id: 26260 };
    ...
    it('dispatches PARTIAL_UPDATE_CANTOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CANTOR actions', async () => {
      const arg = 42666;
